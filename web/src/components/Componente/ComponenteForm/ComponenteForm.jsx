  ...
  return (
    <Card
      ...
      sx={{
        ...
        bgcolor: 'background.paper', // Crucial para Dark Mode
        height: '100%',
    ...
    >
      ...
      />
      <CardContent sx={{ px:3, pt: 2.5, pb: 2.5, flexGrow: 1 }}>{children}</CardContent>
    </Card>
  )
}
    ...
    <Box sx={{ width: '100%', maxWidth: 1500, mx: 'auto' }}>
      ...
      >
        ...
        <Box sx={{
          ...
          // Eliminado borderBottom para limpieza visual
        }}>
          <Avatar
            sx={{
              width: 48, height: 48,
        ...
        <Box component="form" onSubmit={handleSubmit(onSubmit)} noValidate sx={{ px: 5, pb: 5, pt: 0 }}>
          ...
          <Box sx={{
            ...
            alignItems: 'start'
              ...
              {/* --- SECCIÓN 2: CLASIFICACIÓN (SECUNDARIO/CYAN) --- */}
              <SectionCard 
                ...
                <Stack spacing={2.5}>
                  ...
                  <Box>
                    ...
                    {watchedCategoria ? (
                        ...
                        render={() => {
                          ...
                          return (
                            <Stack spacing={2}>
                              ...
                              {/* Versiones Dinámicas - Estilo Dark Mode Friendly */}
                                      ...
                                      >
                                        ...
                                        <TextField
                                          ...
                                          sx={{ 
                                            ...
                                            maxWidth: '60%',
                                            '& .MuiInputBase-root': {
                                              bgcolor: 'background.paper' // Input legible en dark mode
                                            }
                                          }}
                                          InputProps={{
                      ...
                      <Paper variant="outlined" sx={{ p: 2, bgcolor: theme.palette.mode === 'dark' ? 'rgba(230, 81, 0, 0.1)' : '#fff3e0', borderColor: 'warning.main' }}>
                        <Typography variant="body2" color="warning.main" fontWeight={600} sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                            <WarningAmberIcon fontSize="small" />
                           Seleccione una **Categoría** para cargar opciones.
                        </Typography>
                      </Paper>
                    )}
                  </Box>
            ...
            {/* BOTONES (Pill Shape + Colores Aprendidos) */}
            <Box sx={{ mt: 5, display: 'flex', justifyContent: 'center', gap: 2 }}>
              ...
              <LoadingButton
                ...
                startIcon={<SaveIcon />}
                sx={{
                  background: 'linear-gradient(135deg, #1565C0 0%, #7B1FA2 100%)', // Gradiente
