...
export const formatTecnologia = (tecnologia) => {
  try {
...
export const mapEstadoDespliegue = (estado) => {
  const estados = {
...
export const getEstadoDespliegue = (componentes, entorno) => {
...
export const getMachineAdmins = (sistemaDetails) => {
...
export const generateReportData = (sistemaDetails) => {
  ...
  const machineAdmins = getMachineAdmins(sistemaDetails)
...
export const generatePDF = async (sistemaDetails) => {
  const reportData = generateReportData(sistemaDetails)
  if (!reportData) {
